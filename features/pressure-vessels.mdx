...
Once vessel parameters are entered they are used throughout the application:

1. **Support Design** (`/soporte-diseno`) — vessel geometry and weight are pre-populated in the Geometry & Weight card.
2. **Support Analysis** (`/soporte-analisis`) — operating weight and dimensions drive the analytics metrics and charts.
3. **Weld Design** (`/soldadura-diseno`) — vessel outer diameter and wall thickness inform attachment weld sizing.

The vessel definition is therefore the single source of truth for the entire calculation chain.
