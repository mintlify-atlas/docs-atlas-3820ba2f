...
This guide walks you through creating an account, entering a complete support design, and reviewing the analysis results.
...
<Steps>
  ...
  <Step title="Sign in">
    Go to `/login` and enter your email and password. After successful authentication you will land on the home page (`/inicio`).
  </Step>

  <Step title="Open Support Design">
    In the left sidebar, expand **Elementos a presión** and click **Diseño de soportes**. This opens the support design input form at `/soporte-diseno`.
  </Step>
  ...
  <Step title="Configure seismic loading">
    ...
    **COVENIN** (for Venezuelan projects):
    - **Ciudad** — city name
    - **Estado** — select from all 24 Venezuelan states and Distrito Capital
